const age = '<p class="viewer-card__profile-age">Created on: loading..</p>';

const history = `
<div class="tw-flex">
	<div class="tw-flex tw-absolute">
		<button class="tw-flex tmt-name-history-button" data-toggle="tmt-name-history-balloon">
			<figure class="tw-svg">
		...
		<div class="tw-balloon tw-balloon tw-balloon--down tw-balloon--center tw-block tw-absolute tmt-hidden tmt-name-history-balloon">
			...
			<div class="tw-border-t tw-border-r tw-border-b tw-border-l tw-elevation-1 tw-border-radius-small tw-c-background">
				<div class="tw-c-text tw-flex tw-flex-wrap tw-pd-1">
					<div class="tmt-name-history-list">
						<h5>Name History</h5>
